...
if(IsMiniPack)
{
    write-diagprogress -activity $Strings_WinMini8Strings.ProgressText_Detecting
}
...
function Post-Detect
{
    #Log
}

Pre-Detect
Detect -arguments $args
Post-Detect
# SIG # Begin signature block
# MIIarQYJKoZIhvcNAQcCoIIanjCCGpoCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUiHgDPxE0nkTgHt53icS0i5nI
# L1GgghWCMIIEwzCCA6ugAwIBAgITMwAAAI1AOzwvrcZ7uAAAAAAAjTANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFObw
# EaOE4tST4KXoAUGrUkB68Xg9ME4GCisGAQQBgjcCAQwxQDA+oByAGgBXAGkAbgA4
# AFIAQwAuAFQAUwAuAHAAcwAxoR6AHGh0dHA6Ly9zdXBwb3J0Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAUbVkN1/ImOkqSUts45QlQgiYiNuXtTXAu10I
# 2BQsZZSXuEM7jhMilia6vzQrzVghJiTfxHC8259EqDkiwuygSl+edYnaC46OmTCc
# VueSA7aKLSv3NB3+uP/qYatbUrg+y6gQX/giNORfeEAdYtVX2ahMPPDZMz6fPScn
# Xu9RGrt8HI1MTVcvceVYucOES0ush7rnS0HZ+EdzWs/mg2sC6e+ch/w3bKkkplDg
# yrg1qxQyxXQ/Z06B/fiiI4+NUbKdMJJXsVr3ZkaxRcm446vPg33AJlOk3xXS3xYO
# vGlMThc+tbj6oQYT3Lzjz0CbdTZw4qs2gDDEVO1sUl5YSDQBPKGCAigwggIkBgkq
...
# hvcNAQkEMRYEFLvyhj3mbhuLWCsXmac98vtoeiYeMA0GCSqGSIb3DQEBBQUABIIB
# AGU+aKnBMzbvbB9oBNbLpvGb4Y6PNR5BiyI5IjZFFojWqNQ/SxrzGbE8KPxRcDDz
# d/5oj5Ya5zyESs8tiu+ZGnydG7chAf8Q3CVNMHzb3pVkdwgBgMNiX/mBcgQmN3SV
# v8ZuyEfft2/MDMK4v01qt2ru0ZUfUe8LmqzlDwONVeKZ1FrYxhOWNSLWBwcQFtjD
# 3GTWb6naTC+uUqi740yIGSnQnsodZGQ4sD05X+2BAiP1AEVbE+6QSx0LR+pU6LWE
# cyyCbKOMpMlXfJoku/h7Iurg1/aIqeRLbXQ/irkxRBnzc/K/fEf/M+JSQUY7isyO
# UEpbJ8Km8ZbP9bQFk8GXRzQ=
