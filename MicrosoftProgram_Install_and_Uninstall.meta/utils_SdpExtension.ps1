...
function Set-RootCauseResolvedMark([string] $RootCauseID)
{
    if(!$RootCauseID)
    {
...
function Test-RootCauseResolvedMark([string] $RootCauseID)
{
    if(!$RootCauseID)
    {
        throw "No root cause ID is specified"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU2KPlW001KJvntaUWxZivowzm
# EBugghWCMIIEwzCCA6ugAwIBAgITMwAAAI1AOzwvrcZ7uAAAAAAAjTANBgkqhkiG
...
# iAW+5neZbb8cCF+tdeQvqmiXMGAGCisGAQQBgjcCAQwxUjBQoC6ALAB1AHQAaQBs
# AHMAXwBTAGQAcABFAHgAdABlAG4AcwBpAG8AbgAuAHAAcwAxoR6AHGh0dHA6Ly9z
# dXBwb3J0Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEBBQAEggEAbvF42cg/WY+m
# SpYdl3/sHEa3i2Eeupwk82J57jgPpSiYJAQdpM4n/Tkc2smDlK2qk0rZdYjhpl4p
# g4mGKIFTr36xxrwPt9hV9raEBK4pqBZ8jMocffJ+534WFezK36KBi7GDwNhIddoo
# FdWEC9Pwt5zsmY8MGZugSnWkN+yK5bRFAUg75w7q/1PMHEu8YueLNPcGITUS7Qeb
# QMPCXbU5iqQKUDY96cSaJyxY3MliYSFF4M6OauIghf0McsjlvRWeScAAbvjdIW0y
# 48Ix4/btW2UQyfPE54yusdgcsAoWMi/DdxyHT0LT0hRGTCSvo1bGGwLXxPcIa19W
# aCfgxprPmaGCAigwggIkBgkqhkiG9w0BCQYxggIVMIICEQIBATCBjjB3MQswCQYD
...
# MTIxNzA4NTMwOVowIwYJKoZIhvcNAQkEMRYEFO2FdHFAMTqLfb9LdS2fDBDp6f9g
# MA0GCSqGSIb3DQEBBQUABIIBACvYuVbP43hMcew45ZBXicEQf3/fYpbB4z09fe5v
# LjZU1cHcrtT7rlrxoLJMS0U7FSmjYe/wEkvp50mPIpnP0ZuKVxAo3hKNkL5FQq+Q
# TqM4uze99a4tEOqqKVLUFMwYKV/xO5nCk+ZwsRMAltCY5igd9YgZ3GWxRiJE6hbS
# tnbzoGOwNDDE2/UB6PuuciZ/j6RmbFhXgOfxEfw/s/S/X1oldNJdPKxLPCyraM9g
# Hr3IjrTnLxthlzK4TCHU4W9W/Nv4mrvipOU47C0k3Skz83FrGQRQh/iFmdyzjYcL
# 5UZjCMLVEXBZ3LnjPdOmFXnqp8XaharHjkbl4s6qqnBrK+k=
