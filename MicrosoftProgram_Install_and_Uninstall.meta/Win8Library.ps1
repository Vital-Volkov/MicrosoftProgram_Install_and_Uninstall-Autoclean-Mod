...
function DetectRestorePoint()
{
    return $(Test-Path ".\RestorePoint.Mark" -PathType Leaf)
}


function MarkRestorePoint()
{
    get-date | Out-File ".\RestorePoint.Mark"
}

function CreateRestorepoint($RestorePointDesc)
{
    if(!($DetectRestorePoint))
    {
        MarkRestorePoint

        $RestoreSetting_Modify = 0;
        $RestoreSetting_Begin  = 100;
        $Restore = [WMIClass]"ROOT\DEFAULT:SystemRestore"
        $Restore.CreateRestorePoint($RestorePointDesc, $RestoreSetting_Modify, $RestoreSetting_Begin)
    }
}


function DetectEulaMark()
{
    return $(Test-Path ".\Eula.Mark" -PathType Leaf)
}


function MarkEula()
{
    get-date | Out-File ".\Eula.Mark"
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUJC8PnWeIUJRSX7rKm9VqHurz
# glKgghWCMIIEwzCCA6ugAwIBAgITMwAAAI1AOzwvrcZ7uAAAAAAAjTANBgkqhkiG
...
# AAEAAAEKMAkGBSsOAwIaBQCggbIwGQYJKoZIhvcNAQkDMQwGCisGAQQBgjcCAQQw
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFMLe
# LsylpZeieoQFTIrmcPyc4BaAMFIGCisGAQQBgjcCAQwxRDBCoCCAHgBXAGkAbgA4
# AEwAaQBiAHIAYQByAHkALgBwAHMAMaEegBxodHRwOi8vc3VwcG9ydC5taWNyb3Nv
# ZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAC98IiEMCxk+ZUNmV5NvwBZxETdkh01v
# ndo2BNjfXGM4aSqXsCbxLdW81oOhhaqWtYvXDVCVpQlvoebT9WKyZCWb63iR2by8
# HUPIOlTAjB0ulHXk5TSkme/nyECWxColOCNtbM30uFNdy8z6F4yQk0ZflVYsVJdW
# trYdNpfR+VRzZvXeCWNBsjwt6iu0FQUe8VhP9FpEFcc8PXDOmKg0IuKtwOIkHwYr
# CPJ15J3YWNvn0mn+/zYvkSZqKq9RKBlIKSr1hykJ6CBxyAKyhz4QalNzNUs0WfVx
# zeBH3akK3Oz/Z0pDGBAx4QQhM9iwcn5EISKDLKqqa+G0qY5MlJwqPbChggIoMIIC
...
# UENBAhMzAAAAjUA7PC+txnu4AAAAAACNMAkGBSsOAwIaBQCgXTAYBgkqhkiG9w0B
# CQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0xNTEyMTcwODUzMDZaMCMG
# CSqGSIb3DQEJBDEWBBSL25Jby4YQkYYRWGFZLvjiavMCWzANBgkqhkiG9w0BAQUF
# AASCAQAm0bWeTpjz2jnSmLuVPbU88hSt/sYOBUe/j+JbzAEoOiZgEcyKP5fwbKGG
# As0jq3rMwrcD3L9sOyncekawlVN2KQBpsJvlG7LKo9+X3Z96p3vg95zKFTgAsUly
# uZxFYKbsLG64emjwx81Tbt1twvgaTVZWkUgHK4Hd7fXM7mAE8M7bzQxZO58tOhNO
# CEExJ221kTgdnzuIB+yBV6mmcuWnKeG7y35uqxqBRpCrSybRCtEKeQaWnY0dxEl+
# baCWj26i2ijgHZurWuk5gmPKpRfmG+iSR/E6lqhXTNd9m6YsrZ7Aj2Vwsy1xX66k
# tT0FvOCIVZw4/RYwl5pvZhNjBHCH
